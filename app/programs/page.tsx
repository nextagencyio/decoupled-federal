...
export const metadata: Metadata = {
  title: 'Programs & Grants | U.S. Department of Innovation',
  description: 'Browse federal programs and grants from the U.S. Department of Innovation.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-primary-200">
              Explore federal programs, grants, and funding opportunities.
            </p>
          </div>
        </div>
      </section>
