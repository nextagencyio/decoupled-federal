...
export const metadata: Metadata = {
  title: 'Leadership | U.S. Department of Innovation',
  description: 'Meet the leadership of the U.S. Department of Innovation.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-primary-200">
              Meet the officials leading the U.S. Department of Innovation.
            </p>
          </div>
        </div>
      </section>
