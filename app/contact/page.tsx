...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Federal Services Portal. We\'d love to hear from you about federal services, programs, or public information.',
  keywords: ['Contact Federal Services Portal', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about federal services, programs, or public information? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@federalservices.gov</p>
                    <p className="text-gray-600">support@federalservices.gov</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 456-7809</p>
