...
export const metadata: Metadata = {
  title: 'Press Releases | U.S. Department of Innovation',
  description: 'Browse press releases and official statements from the U.S. Department of Innovation.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-primary-200">
              Official press releases and statements from the Department.
            </p>
          </div>
        </div>
      </section>
